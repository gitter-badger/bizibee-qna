...
(4,2,0,-0.050921,0,0,1,0.025,'350 ml dökülme karşıtı',0.0484966622162884,5),
(5,2,0,-0.006496,0,0,1,0.010,'350 ml güzellik',0.00625,3),
...
(17,2,0,-0.006653,0,0,1,0.13,'600 ml kepek şampuanı',0.00625,3),
(18,2,0,-0.004877,0,0,1,0.04,'600ml+200ml güzellik + bakım copack',0.00464,4),
(19,2,FLOOR(RAND()*(-1000-(-36000)+1))+(-36000),-1+2*RAND(),120,75,1,-1+2*RAND(),'600ml+200ml kepek+güzellik copack',-1+2*RAND(),3),
(20,2,0,-0.051891,120,90,1,0.18,'900 ml bakım şampuanı',0.0484966622162884,5),
...
VALUES
	...
	(7,2,UUID(),FLOOR(RAND()*(-1000-(-36000)+1))+(-36000),'PLANOGRAM1','Description about Planogram',-1+2*RAND(),-1+2*RAND(),'Planogram','Remark about Planogram',1,13,-1+2*RAND()),
