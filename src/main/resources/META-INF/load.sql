...
INSERT INTO `SKUENTITY` (`ID`,`SIMULATION_ID`,`NAME`,`BRAND_ID`) VALUES 
(1,2,'200 ml güzellik',3),
(2,2,'200 ml kepek',3),
(3,2,'350 ml bakım',4),
(4,2,'350 ml dökülme karşıtı',5),
(5,2,'350 ml güzellik',3),
(6,2,'350 ml kepek',3),
(7,2,'400 ml bakım',5),
(8,2,'400 ml güzellik',5),
(9,2,'500 ml bakım',4),
(10,2,'500 ml dökülme karşıtı',4),
(11,2,'500ml+350ml bakım+dökülme karşıtı',4),
(12,2,'600 ml + 200ml bakım + güzellik copack',5),
(13,2,'600 ml + 200ml güzellik + kepek copack',3),
(14,2,'600 ml bakım şampuanı',5),
(15,2,'600 ml güzellik şampuanı',3),
(16,2,'600 ml güzellik şampuanı',5),
(17,2,'600 ml kepek şampuanı',3),
(18,2,'600ml+200ml güzellik + bakım copack',4),
(19,2,'600ml+200ml kepek+güzellik copack',3),
(20,2,'900 ml bakım şampuanı',5),
(21,2,'900 ml dökülme karşıtı şampuanı',4),
(22,2,'TG',1),
(23,2,'DH',2);

INSERT INTO `DECISIONENTITY` (`ID`, `SIMULATION_ID`, `UUID`, `DECISIONTYPE`, `DESCRIPTION`, `NAME`, `REMARK`, `REQUIRED`, `SORTORDER`)
VALUES
	(1,2,UUID(),'SINGLE_SKU_LISTING','Description about Volume Hunting','Volume Hunting','Remark about Volume Hunting',1,1),
	(2,2,UUID(),'SINGLE_SKU_LISTING','Description about Delisting','Delisting','Remark about Delisting',1,3),
	(3,2,UUID(),'MULTIPLE_SKU_LISTING','Description about Listing','Listing','Remark about Listing',1,5),
	(4,2,UUID(),'RANGE_SKU_LISTING','Description about Price Positioning','Price Positioning','Remark about Price Positioning',1,7),
	(5,2,UUID(),'MULTIPLE_CHOICE','Description about E-Commerce Investment','E-Commerce Investment','Remark about E-Commerce Investment',1,9),
	(6,2,UUID(),'MULTIPLE_CHOICE_SKU_LISTING','Description about Display','Display','Remark about Display',1,11),
	(7,2,UUID(),'PLANOGRAM1','Description about Planogram','Planogram','Remark about Planogram',1,13),
	(8,2,UUID(),'SINGLE_CHOICE_SKU_LISTING','Description about Promotion','Promotion','Remark about Promotion',1,15),
	(9,2,UUID(),'MULTIPLE_CHOICE','Description about Team Management','Team Management','Remark about Team Management',1,17),
	
	(10,2,UUID(),'SINGLE_CHOICE','Description about Question1','Question1','Remark about Question1',1,2),
	(11,2,UUID(),'SINGLE_CHOICE','Description about Question2','Question2','Remark about Question2',1,4),
	(12,2,UUID(),'SINGLE_CHOICE','Description about Question3','Question3','Remark about Question3',1,6),
	(13,2,UUID(),'SINGLE_CHOICE','Description about Question4','Question4','Remark about Question4',1,8),
	(14,2,UUID(),'SINGLE_CHOICE','Description about Question5','Question5','Remark about Question5',1,10),
	(15,2,UUID(),'SINGLE_CHOICE','Description about Question6','Question6','Remark about Question6',1,12),
	(16,2,UUID(),'SINGLE_CHOICE','Description about Question7','Question7','Remark about Question7',1,14),
	(17,2,UUID(),'SINGLE_CHOICE','Description about Question8','Question8','Remark about Question8',1,16),
	(18,2,UUID(),'SINGLE_CHOICE','Description about Question9','Question9','Remark about Question9',1,18);
...
INSERT INTO `WEIGHTENTITY` (`SKU_ID`, `DECISION_ID`)
VALUES
	(9,1),
	(14,1),
	(17,1),
