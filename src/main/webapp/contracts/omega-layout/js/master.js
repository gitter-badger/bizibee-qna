...
function planogram(e, slotId, skuId) {
//    alert(skuId);
//    alert(slotId);
...
//    $('#item' + slotId).html($('<span>', {class: 'fa fa-cube', title: skuName, style: 'font-size: smaller;'}));
//    
//    alert($(e).attr('id'));
//    alert($(e).parent().parent().next().find('img').attr('src'));
    ...
    $('#item' + slotId).html($('<img>', {id: 'image' + skuId, src: src, alt: alt, title: title, width: width, height: height}));
}
